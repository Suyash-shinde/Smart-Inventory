...
const Maintenance = () => {
  ...
  return (
    ...
    // <div className="w-full h-min-screen bg-background text-foreground">
    //   <header className="flex items-center justify-center w-full h-12 bg-background text-foreground">
    ...
    //         type="search"
    //         placeholder="Search"
    //         className="w-full max-w-md px-4 py-2 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary bg-card text-foreground "
    //       />
    //     </div>

    //     <div className="flex flex-col items-center px-4 py-3 space-x-4 bg-background text-card-foreground border border-border rounded-md sm:flex-row">
    //       <div className="flex flex-col w-full space-y-4">
    //         <div className="flex space-x-4">
    //           <select
    //             name="device-type"
    ...
    //             className="w-full px-2 py-2 bg-card text-card-foreground border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
    //             value={selectedDevice}
    //             onChange={(e) => setSelectedDevice(e.target.value)}
    //           >
    //             {Options.device.map((option) => (
    ...
    //       <div>
    //         <button
    //           className="px-8 py-2 mb-3 text-white rounded-md sm:mt-0 bg-primary text-primary-foreground"
    //           onClick={handleFilter}
    //         >
    //           Filter
    //         </button>
    ...
    //         <button
    //           className="px-8 py-2 mt-3 text-white bg-destructive text-destructive-foreground rounded-md sm:mt-0"
    //           onClick={reset}
    //         >
    //           Reset Filter
    //         </button>
    ...
    //           <li
    //             key={issue._id}
    //             className="flex justify-between border border-border rounded-md cursor-pointer bg-card text-card-foreground"
    //             onClick={() => handleOpenModal(issue)}
    //           >
    //             <div className="flex flex-col self-center w-11/12 p-4 space-y-2 rounded-l-md">
    //               <h6>Issue Id: {issue._id}</h6>
    //               <h6>Date: {issue.date}</h6>
    //               <h6>Faculty: {issue.facultyLabIncharge}</h6>
    //               <h6>Lab: {issue.labNo}</h6>
    //               <h6>Device: {issue.deviceType}</h6>
    //             </div>
    //             <div
    //               className={`flex items-center justify-center w-1/12 rounded-r-md ${
    //                 issue.status === "Completed"
