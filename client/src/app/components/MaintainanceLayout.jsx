...
const MaintainanceLayout = ({data, issueDevice}) => {
                        ...
                        if(device.position <= (data.row) * (data.column) ){
                            return (
                                <div key={device.id} className='w-6 h-6'>
                                    <Card3  issueDevice={ issueDevice } deviceId={device.id} key={device.id} position={device.position} selected={device.selected} isVisible={device.isVisible}></Card3>
                                </div>
                            )
                        }
                })}
...
export default MaintainanceLayout
