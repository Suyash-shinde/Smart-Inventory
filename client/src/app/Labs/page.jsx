...
const Labs = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3090/getAllLabs")
      .then((response) => {
  ...
  return (
    <div className="min-h-screen p-6 bg-background ">
      <div className="flex flex-wrap justify-center p-10 bg-card  border-2 shadow-lg rounded-xl">
                ...
                <div className="absolute inset-0">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end text-white rounded-xl">
                    <div className="content-end w-full p-4 bg-gradient-to-t rounded-xl from-black/80 to-transparent h-1/2">
                      ...
                      <p className="text-sm">
                        {lab.labDescription || "Lab desc expected"}
                      </p>
                    </div>
                  </div>
                </div>
                <div className="absolute inset-0 h-full w-full rounded-xl backdrop-blur-3xl p-6 text-center bg-black/70 text-slate-200 [transform:rotateY(180deg)] [backface-visibility:hidden]">
                  <div className="flex flex-col items-center justify-center min-h-full">
                    ...
                    <p className="mt-2 text-lg">
                      Incharge: {lab.incharge || "N/A"}
                    </p>
                    <p className="mt-4 text-base">
                      {lab.labDescription || "No description available"}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-card flex flex-wrap justify-center p-10 mt-6  border-2 shadow-lg rounded-xl">
        <div className="w-full mb-8">
          <h1 className="text-5xl font-bold text-center text-foreground">
            Class Rooms
          </h1>
      ...
      <div className="flex flex-wrap bg-card justify-center p-10 mt-6  border-2 shadow-lg rounded-xl">
        <div className="w-full mb-8">
          <h1 className="text-5xl font-bold text-center text-foreground">
            Staff Room
          </h1>
