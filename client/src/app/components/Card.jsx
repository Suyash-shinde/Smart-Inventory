...
const Card = ({id,isVisible,selected}) => {
  ...
  return (
    ...
    :<div key={id} className=" group absolute h-10 w-10 rounded border-4 flex items-center justify-center border-green-500 font-extrabold text-green-500 font-mono hover:cursor-pointer">
      {id}
      <div className=" transition transform translate-y-8 ease-in-out  h-14 w-20  invisible group-hover:visible absolute pr-10 pl-10 pt-2 pb-2 group-hover:translate-y-0 mb-28 z-1 bg-green-300 text-white rounded">
        {id}
      </div>
